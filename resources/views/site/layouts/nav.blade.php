<nav id="nav" class="fixed inset-x-0 top-0 z-10 text-white" style="">
	...
	<div class="search-full-page absolute h-screen top-0 right-0" style="overflow: hidden;">
		<div class="search-page h-screen fixed bg-black bg-opacity-50 p-8 pr-32 pt-24 text-center" onmouseleave="hiddenSearchPage()">
			...
			<div class="grid grid-cols-3 gap-2">
				...
				@foreach($categories as $category)
				<button class="flex-shrink-0 bg-blue-400 hover:bg-blue-700 border-blue-400 hover:border-blue-700 text-sm border-4 text-white py-1 px-2 rounded transition duration-200" type="submit">
					TAGS
				</button>
				@endforeach
